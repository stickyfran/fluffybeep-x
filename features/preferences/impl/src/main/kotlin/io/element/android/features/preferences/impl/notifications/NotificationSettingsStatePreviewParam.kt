...
fun aValidNotificationSettingsState(
    ...
    groupNotificationCooldown: io.element.android.libraries.preferences.api.store.GroupNotificationCooldown = io.element.android.libraries.preferences.api.store.GroupNotificationCooldown.OFF,
    showGroupCooldownDialog: Boolean = false,
...
fun aInvalidNotificationSettingsState(
    ...
    groupNotificationCooldown = io.element.android.libraries.preferences.api.store.GroupNotificationCooldown.OFF,
